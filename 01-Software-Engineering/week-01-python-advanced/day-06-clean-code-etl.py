...
def filtrar_transacciones_validas(
...
def procesar_pipeline_ventas(
    ...
    datos_procesados = [
        calcular_impuestos_y_totales(trx) for trx in transacciones_validas
    ]
